...
@Component({
  selector: 'app-listar-rutas2',
  templateUrl: './listar-rutas2.component.html',
  styleUrls: ['./listar-rutas2.component.css']
})
export class ListarRutas2Component implements OnInit {
